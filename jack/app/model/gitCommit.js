(function($) {
	...
	App.Model.GitCommit.prototype = FL.extend(FL.Model, {
		...
		Mapper : {
			...
			getAll : function(callback)
			{
				...
				$.getJSON('http://github.com/api/v2/json/commits/list/fkadeveloper/FLpack/master?page=1&callback=?', function(response) {
					...
					for (var index in response.commits)
					{
						...
						_commit = FL.newInstance('App.Model.GitCommit');
