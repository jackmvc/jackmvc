...
var Ppp = function () {
    ...
    // runs callback functions set by Ppp.addResponsiveHandler().
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    Ppp.unblockUI(pageContent);
                    pageContentBody.html(res);
                    Ppp.fixContentHeight(); // fix content height
                    Ppp.initAjax(); // initialize core stuff
                },
